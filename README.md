...
- 만약 <span style="background-color: lightgray">[사용자이름].github.<span style="color : red">com</span></span>이라는 저장소와 <span style="background-color: lightgray">[사용자이름].github.<span style="color : red">io</span></span>라는 저장소가 공존하는 경우 오직 `<사용자이름>.github.io` 만 사이트로 배포된다. 
...
# 3. 완료
![](https://velog.velcdn.com/images/chan9708/post/812fd774-49d6-47fe-badf-beb84317d0bc/image.png)
